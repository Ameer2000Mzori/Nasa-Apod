...
> Nasa-Apod website uses NASA API for info and pictures. Favorites can be saved to local storage. Created with HTML, CSS, and JavaScript, it employs ESLint for code error handling. Check out the live demo!
...
- [Live Demo Link](https://ameer2000mzori.github.io/Nasa-Apod/dist/index.html)
